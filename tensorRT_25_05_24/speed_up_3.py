...
with open('performance_metrics3.csv', 'w', newline='') as csvfile:
    ...
    while True:
        ...
        start_time_yolo = time.time() #########
        results = model.track(im0, persist=True, classes=[0,2,3,5,7])
